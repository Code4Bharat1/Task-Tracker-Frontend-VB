            ...
            <div className="divide-y divide-outline">
              {data.map((emp) => {
                ...
                return (
                  <div
                    key={emp.userId}
                    className="grid grid-cols-[40px_2fr_1fr_1fr_120px] gap-4 px-6 py-4 items-center transition-colors hover:bg-surface-container"
                  >
                    {/* Rank */}
                    <div
